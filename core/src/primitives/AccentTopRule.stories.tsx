...
export const Centered: Story = {
  render: () => (
    <div style={{ maxWidth: '600px' }}>
      ...
      <p style={{ textAlign: 'center' }}>Section content below the centered accent rule</p>
    </div>
  ),
}
...
export const RightAligned: Story = {
  render: () => (
    <div style={{ maxWidth: '600px' }}>
      ...
      <p style={{ textAlign: 'right' }}>Section content below the right-aligned accent rule</p>
    </div>
  ),
}
